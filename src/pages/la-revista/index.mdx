...
El magazine **CompartiMOSS** es una revista trimestral con información en castellano sobre tecnología Microsoft.
...
export const pageQuery = graphql`
    query {
        allMdx(
            ...
            filter: {
                frontmatter: {type: {eq: "author"}, director: {eq: true}}
            }) 
            {
                edges {
                    node {
