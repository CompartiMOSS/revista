**RESTAURAR MILES DE ELEMENTOS DE LA PAPELERA DE RECICLAJE DE SHAREPOINT
ONLINE**
...
![](c:\CompartiMOSS\convert\restaurar-elementos-de-la-papelera-con-powershell-enrique-sanchez/media/image1.png){width="4.389741907261592in"
height="2.5902777777777777in"}

**Imagen 1.- Mensaje que muestra el cliente de ODFB cuando se eliminan
archivos.**
...
![](c:\CompartiMOSS\convert\restaurar-elementos-de-la-papelera-con-powershell-enrique-sanchez/media/image2.png){width="5.905555555555556in"
height="2.0861111111111112in"}

**Imagen 2.- Experiencia de usuario al visualizar en la papelera los
archivos eliminados desde el cliente de ODFB.**
...
![](c:\CompartiMOSS\convert\restaurar-elementos-de-la-papelera-con-powershell-enrique-sanchez/media/image3.png){width="5.905555555555556in"
height="0.8388888888888889in"}

**Imagen 3.- Experiencia de usuario al visualizar en la papelera los
archivos eliminados desde el cliente Web.**
...
c)  Fecha a partir de la cual queremos restaurar los que fueron
    > eliminados
...
Write-Verbose \"Performing API Call to Restore item from
RecycleBin\...\"
...
write-host \"\$(\$n.ToString(\"0000\")) - ERROR AL RESTAURAR
\'\$(\$ritem.Title)\'\|ERROR:\'\$(\$\_.Exception.Message)\':
...
write-host \"NO se han encontrado elementos eliminados por el usuario
\'\$(\$userDelete)\' posteriores a la fecha
\$(\$restoreDate.ToShortDateString())\" -ForegroundColor Yellow
