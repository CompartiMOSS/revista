**La Inteligencia Artificial mediante Redes Generativas Antagónicas
(GAN's)**
...
***[Generador]{.ul}*** intenta generar nuevos datos partiendo de un
...
***[Discriminador]{.ul}***, intenta encontrar si determinado dato es
...
![](c:\CompartiMOSS\convert\redes-generativas-antagonicas-javier-menendez/media/image3.png){width="4.95in"
height="2.6881944444444446in"}Seguramente en las primeras ejecuciones
