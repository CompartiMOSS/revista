...
+===================================+===================================+
| Give me a plan for visiting:      | \{                                 |
| \{\{$City}}". I will be there for:  |                                   |
| \{\{$NumberOfDays}}" days.          | "schema": 1,                    |
|                                   |                                   |
| I am more interested in food and  | "description": "Given a city   |
| less in places or monuments. I    | and the number of days to spend   |
| just need 2-3 activities per day. | in there, it gives you a detailed |
|                                   | plan of what to do in that city   |
| Format output as markdown format, | on each day",                    |
| with headings for DAY 1, DAY 2,   |                                   |
| etc, and then the list of         | "models": [                    |
| activities as bullet point list.  |                                   |
|                                   | \{                                 |
|                                   |                                   |
|                                   | "max_tokens": 2000,             |
|                                   |                                   |
...
|                                   | "name": "City",               |
|                                   |                                   |
|                                   | "description": "The city you   |
|                                   | want to travel to and wanto to    |
|                                   | plan what to do in there",       |
|                                   |                                   |
...
|                                   | days you are going to be in the   |
|                                   | city.",                          |
|                                   |                                   |
|                                   | "defaultValue": "3"           |
|                                   |                                   |
...
| \{\{GraphSkillsPlugin.GetMySkills}} | of Skills returned by my Graph    |
|                                   | profile, with a brief definition  |
| [Skills]                        | for each skill",                 |
|                                   |                                   |
| Now give me the same list, but    | "models": [                    |
| add a brief                       |                                   |
