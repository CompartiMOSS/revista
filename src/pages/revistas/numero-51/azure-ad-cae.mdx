...
+-----------------------------------+-----------------------------------+
| Para los que no estuvisteis en la | ![Interfaz de usuario gráfica,    |
| Preview de CAE, no os preocupéis, | Texto, Aplicación Descripción     |
| no tenéis que hacer nada, CAE     | generada                          |
| estará activo en todas aquellas   | automáticamente](C:\Compar        |
| políticas de Acceso Condicional   | tiMOSS\convert\azure-ad-cae-alber |
| que tengáis ya implementadas,     | to-andres-rodriguez/media/image4. |
| pero si se da el caso de que      | png){width="1.6756988188976378in" |
| queréis desactivarlo de alguna de | height="4.317442038495188in"}     |
| ellas, el procedimiento es        |                                   |
| simple.                           |                                   |
|                                   |                                   |
| Accedemos a la politica de AC en  |                                   |
| cuestión y vamos al apartado de   |                                   |
| sesión:                           |                                   |
+===================================+===================================+
+-----------------------------------+-----------------------------------+
