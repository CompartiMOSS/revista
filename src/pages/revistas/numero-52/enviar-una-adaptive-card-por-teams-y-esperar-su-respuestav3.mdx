...
```
  ...
  ----------------------------------- -----------------------------------
  id                                  Id del control y variable que
                                      después utilizamos en Teams para
                                      actualizar un determinado campo

  isRequired                          Si el campo es obligatorio

  errorMessage                        Mensaje para mostrar en caso de que
                                      el control tenga isRequired en true

  placeholder                         Opción para mostrar en el
                                      placerholder (Marca de agua, en el
                                      caso de ejemplo no es necesario)

  choices                             Opciones para mostrar y su valor
                                      interno
...
En el componente de Teams, configuramos las siguientes opciones:
  ...
  Update message (Dicho mensaje       Gracias!
  actualiza la tarjeta una vez que el 
