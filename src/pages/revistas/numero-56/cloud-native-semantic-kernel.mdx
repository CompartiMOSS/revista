...
![Imagen 2.- Arquitectura de referencia de la infraestructura 100% «Cloud Native» que montaremos.](../../../images/numero56/cloud-native-semantic-kernel/image1.png)
...
![Imagen 6.- Donde crear aplicaciones dentro de un Azure Container Environment específico.](../../../images/numero56/cloud-native-semantic-kernel/image1.png)

 
![Imagen 7.- Configurando los datos básicos de la Azure Container App para Qdrant.](../../../images/numero56/cloud-native-semantic-kernel/image1.png)
...
![Imagen 8.- Configuración de la imagen de Qdrant para el Azure Container App.](../../../images/numero56/cloud-native-semantic-kernel/image1.png)
...
![Imagen 9.- Configuración del ingreso (ingress)  para el contenedor de Qdrant. Nótese que el acceso es limitado sólo a otras aplicaciones desplegadas dentro del mismo Azure Container Environment, lo cual se hace por temas de seguridad.](../../../images/numero56/cloud-native-semantic-kernel/image1.png)
...
![Imagen 10.- Creación de un Azure File Share para usar como volumen y preservar los datos de Qdrant.](../../../images/numero56/cloud-native-semantic-kernel/image1.png)
...
![Imagen 11.- Donde encontrar las claves del Azure Storage Account, necesarias para crear la vinculación del Azure File Share como volumen en el Azure Container Environment.](../../../images/numero56/cloud-native-semantic-kernel/image1.png)
...
![Imagen 12.- Configuración del Azure Files en el Azure Container Environment.](../../../images/numero56/cloud-native-semantic-kernel/image1.png)
...
![Imagen 13.- Comando del Azure CLI para extraer la configuración del contenedor de Qdrant.](../../../images/numero56/cloud-native-semantic-kernel/image1.png)
...
![Imagen 14 - Comando de Azure CLI para actualizar el contenedor de Qdrant con la configuración modificada para que tenga un volumen vinculado donde dejar de forma permanente sus datos e información que gestiona.](../../../images/numero56/cloud-native-semantic-kernel/image1.png)
...
![Imagen 15 - Opciones de configuración para Qdrant y Semantic Kernel mantenidas y gestionadas dentro de un Azure App Configuration.](../../../images/numero56/cloud-native-semantic-kernel/image1.png)
